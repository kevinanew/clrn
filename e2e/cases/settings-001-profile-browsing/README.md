...
昵称预填当前值；编辑昵称/签名后取消，重新进入核对原值；浏览等级说明和奖励数值。 每次返回后核对原入口或内容，可继续下一分支。

## 定位契约

username-text、content-text-0/1、nickname-input、bio-input、back-button、user-level-screen；单目标操作前断言可见唯一，业务内容使用文本/表单值断言。

## 关联问题

2026-09-26 已通过真实浏览器探索导航。不保存资料，不领取奖励。
